...
<div>
        ...
        <td rowspan="3" class="table-header"><img src="{{ public_path('img/versión 1 Dos colores-Recuperado.png') }}" class="agsLogo">
        </td>
    ...
    <main>
        ...
        <table>
            ...
            <table>
                ...
                <tr>
                    <th colspan="1" class="celdas">Factura:</th>
                    <td colspan="1">{{ $elemento->factura->codigoFactura ?? 'NO APLICA'}}</td>
                    <th colspan="1" class="celdas">Fecha de compra:</th>
                    <td colspan="1">{{$elemento->factura->fechaCompra ?? 'NO APLICA'}}</td>
                    <th colspan="1" class="celdas">Fecha de baja:</th>
                    <td colspan="1"></td>
                </tr>
                <tr>
                    <td colspan="6" class="separator"></td>
        ...
        <table>
            <tbody>
                <tr id="border">
                    <th colspan="6">MANTENIMIENTO CORRECTIVO O MODIFICACIONES DE HARDWARE EN EL EQUIPO (DD/MM/AAAA)</th>
                </tr>
                <tr>
        ...
        <div class="page_break">
            ...
            <table>
                <tr>
                    <td colspan="6" class="celdas"><b>COMPROMISO:</b> Me comprometo a utilizar adecuadamente durante la jornada laboral los elementos de trabajo recibidos y mantenerlos en buen estado, dándole uso exclusivo para el desarrollo actividades propias del contrato. Declaro que he recibido información sobre el uso adecuado de los mismos.
                        <br>NOTA: El colaborador será el responsable inmediato de los daños ocasionados al equipo de cómputo y sus componentes, en caso de malas prácticas y no acatar las recomendaciones dadas por el proceso de TICS e Innovación, en las políticas del buen uso de los recursos tecnológicos.
                        </td>
                </tr>
                <tr>
