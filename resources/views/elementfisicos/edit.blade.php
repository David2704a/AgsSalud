        ...
        $('#idCategoria').change(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $('#id_dispo').val(response.id_dispo).prop('readonly', true); // Establecer readonly después de llenar el valor
                },
                error: function(xhr, status, error) {
                    ...
                    $('#id_dispo').prop('readonly', false).val(''); // Permitir edición y limpiar el campo en caso de error
                }
            });
        });
    });
