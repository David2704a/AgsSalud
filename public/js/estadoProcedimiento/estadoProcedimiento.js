...
//       $.ajax({
//         url: urlBase+'/estadoProcedimiento/buscar',
//         method: 'GET',
//         data: { filtro: filtro },
...
function inicializarTablaEstadosP() {
    var table = $('#tableEstadosP').DataTable({
        ...
        initComplete: function (settings, json) {
            ...
            $('.tableEstadosP .dataTables_filter input[type="search"]').each(function () {
                var input = $(this);
            ...
            $('.tableEstadosP .dataTables_filter input[type="search"]').attr('type', 'text').attr('placeholder', 'Buscar...');
            ...
            $('.tableEstadosP .dataTables_filter ').prepend(buttonHtml);
            ...
            $('.tableEstadosP .dataTables_filter').append(resetButtonHtml);

            $('.reset').click(function () {
                table.search('').columns().search('').draw();
                $('.tableEstadosP .dataTables_filter input[type="search"]').val('');
            });
        }
    });
}
