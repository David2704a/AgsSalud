...
//       $.ajax({
//         url: urlBase+'/tipoProcedimiento/buscar',
//         method: 'GET',
//         data: { filtro: filtro },
...
//   });
  ...
  */
  ...
  function inicializarTablaTipoP() {
    var table = $('#tableTipoP').DataTable({

        language: textoEspañolTables(),

        initComplete: function (settings, json) {

            $('.tableTipoP .dataTables_filter input[type="search"]').each(function () {
                var input = $(this);
            ...
            $('.tableTipoP .dataTables_filter input[type="search"]').attr('type', 'text').attr('placeholder', 'Buscar...');
            ...
            $('.tableTipoP .dataTables_filter ').prepend(buttonHtml);
            ...
            $('.tableTipoP .dataTables_filter').append(resetButtonHtml);

            $('.reset').click(function () {
                table.search('').columns().search('').draw();
                $('.tableTipoP .dataTables_filter input[type="search"]').val('');
            });
        }
    });
}
